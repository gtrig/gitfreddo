...
export function createGitFreddoMock(overrides: Partial<GitFreddoAPI> = {}): GitFreddoAPI {
  return {
    ...
    githubListPullRequestCommits: vi.fn(async () => []),
    ...
    githubPostPullRequestReviewComment: vi.fn(async () => undefined),
    ...
    gitlabDisconnect: vi.fn(async () => undefined),
    gitlabListRepos: vi.fn(async () => []),
    gitlabListNamespaces: vi.fn(async () => ['namespace']),
    gitlabCreateRepo: vi.fn(async () => ({
      id: 1,
      ...
      owner: 'namespace',
      private: false,
      cloneUrl: 'https://gitlab.com/namespace/repo.git',
      description: null,
      defaultBranch: 'main'
    })),
    gitlabForkRepo: vi.fn(async () => ({
      id: 1,
      fullName: 'namespace/repo',
      name: 'repo',
      namespace: 'namespace',
    ...
    gitlabUploadSshKey: vi.fn(async () => ({ title: 'key', publicKey: 'ssh-rsa test' })),
    gitlabGetRepoContext: vi.fn(async () => null),
    gitlabListPullRequests: vi.fn(async () => []),
    gitlabCreatePullRequest: vi.fn(async () => ({
      number: 1,
      title: 'MR',
      state: 'opened',
      htmlUrl: 'https://gitlab.com/namespace/repo/-/merge_requests/1',
      user: 'test',
      head: { ref: 'feature', sha: 'abc' },
      base: { ref: 'main', sha: 'def' },
      body: '',
    ...
    gitlabMergePullRequest: vi.fn(async () => undefined),
    gitlabListIssues: vi.fn(async () => []),
    gitlabCreateIssue: vi.fn(async () => ({
      number: 1,
      title: 'Issue',
      state: 'open',
      htmlUrl: 'https://gitlab.com/namespace/repo/-/issues/1',
      user: 'test',
      body: '',
      labels: []
    })),
    gitlabUpdateIssue: vi.fn(async () => ({
      number: 1,
      title: 'Issue',
      state: 'open',
      htmlUrl: 'https://gitlab.com/namespace/repo/-/issues/1',
    ...
    onGitlabConnectProgress: vi.fn(() => () => undefined),
