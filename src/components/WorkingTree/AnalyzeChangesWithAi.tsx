  ...
  return (
    <>
      <button
        ...
        title={t('workingTree.analyzeWithAi')}
      >
        {aiBusy ? (
          <Spinner size="sm" />
        ) : (
        ...
        {variant === 'toolbar' && (aiBusy ? t('workingTree.analyzing') : t('workingTree.analyzeWithAi'))}
        {variant === 'pill' && (aiBusy ? t('workingTree.analyzing') : t('workingTree.analyzeWithAiShort'))}
      </button>
